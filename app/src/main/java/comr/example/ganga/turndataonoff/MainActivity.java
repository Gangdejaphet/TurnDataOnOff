package comr.example.ganga.turndataonoff;
        ...
        tBMobileData.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (state) {
                    ...
                    tBMobileData.setImageResource(R.drawable.ic_get_app_black_24dp);

                } else {

                    toggleMobileDataConnection(true);
                    tBMobileData.setImageResource(R.drawable.ic_settings_ethernet_black_24dp);
                }
